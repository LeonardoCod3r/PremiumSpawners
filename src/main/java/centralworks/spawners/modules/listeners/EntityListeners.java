...
public class EntityListeners implements Listener {
    ...
    public void spawn(EntitySpawnEvent e) {
        if (e.getEntity() instanceof Animals || e.getEntity() instanceof Monster) NBTInjector.patchEntity(e.getEntity());
    }
    ...
    public void spawn(SpawnerSpawnEvent e) {
        ...
        if (entity instanceof Animals || entity instanceof Monster) {
            ...
            for (Entity nearbyEntity : entity.getNearbyEntities(entities.getDouble("Settings.area.x"), entities.getDouble("Settings.area.y"), entities.getDouble("Settings.area.z"))) {
                if (nearbyEntity instanceof Animals || nearbyEntity instanceof Monster)
