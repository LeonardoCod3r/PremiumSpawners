...
public class EconomyContext {
    ...
    static {
        ...
        setContexts(Lists.newArrayList(new Context(Lists.newArrayList(PluginSystemType.PRODUCT_STORAGE, PluginSystemType.SPAWNERS_STATISTICS, PluginSystemType.QUESTS, PluginSystemType.SPAWNERS_BUY),
                new Economy() {
                    @Override
